...
public class StudentController {
    ...
    public String editStudent(@PathVariable("studentId") Long studnetId,
                              Model model){
        StudentDto student = studentService.getStudentById(studnetId);
        model.addAttribute("student", student);
        return "edit_student";
    }
    ...
    public String deleteStudnet(@PathVariable("studentId") Long studentId){
